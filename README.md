...
> I have built a this project using pgAdmin 4 and SQL.
...
> Filters out content from the database
...
**``git clone https://github.com/Thinus01/Vet_Clinic``**
